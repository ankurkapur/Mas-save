...
Ext.define('Ext.ux.AccordionList', {
    ...
    onRecordsDelete:function(){
        var me = this;

        me.fireEvent('recordsDeleted',me,me.getList());
    },
    ...
    applyMoreListSetting: function (list) {
        ...
        list.on('disclosure',me.onItemDisclosure);
    ...
    onItemTap: function (list, index, target, record, e) {
        ...
        if (node.isLeaf()) {
            ...
            if (node.isExpanded()) {
                ...
                //list.getAt(index+1).show();
            }
        }
        me.fireEvent('afteritemtap', me, list, index, target, record, e);
        //if (me.getIndent()) {
         //   me.doIndent();
       //}
    },
    ...
    patchStore: function (store) {
        ...
        store.on('removerecords',me.onRecordsDelete,me);
